...
#I
{
	...
	#9 состояние 1-байтные опкоды
	{
		...
		#coprocessor
		$state[0xd8 + (BYTE * 9)] =512 * 204;
		$signal[0xd8 + (BYTE * 9)] = DEFAULT_SIGNAL;
		$state[0xd9 + (BYTE * 9)] =512 * 205;
		$signal[0xd9 + (BYTE * 9)] = DEFAULT_SIGNAL;
		$state[0xda + (BYTE * 9)] =512 * 206;
		$signal[0xda + (BYTE * 9)] = DEFAULT_SIGNAL;
		$state[0xdb + (BYTE * 9)] =512 * 207;
		$signal[0xdb + (BYTE * 9)] = DEFAULT_SIGNAL;
		$state[0xdc + (BYTE * 9)] =512 * 208;
		$signal[0xdc + (BYTE * 9)] = DEFAULT_SIGNAL;
		$state[0xdd + (BYTE * 9)] =512 * 209;
		$signal[0xdd + (BYTE * 9)] = DEFAULT_SIGNAL;
		$state[0xde + (BYTE * 9)] =512 * 210;
		$signal[0xde + (BYTE * 9)] = DEFAULT_SIGNAL;
		$state[0xdf + (BYTE * 9)] =512 * 211;
		$signal[0xdf + (BYTE * 9)] = DEFAULT_SIGNAL;
	}
...
#J
{
	...
	#7 состояние 1-байтные опкоды
	{
		...
		#coprocessor
		$state[0xd8 + (BYTE * 7)] =512 * 212;
		$signal[0xd8 + (BYTE * 7)] = DEFAULT_SIGNAL;
		$state[0xd9 + (BYTE * 7)] =512 * 213;
		$signal[0xd9 + (BYTE * 7)] = DEFAULT_SIGNAL;
		$state[0xda + (BYTE * 7)] =512 * 214;
		$signal[0xda + (BYTE * 7)] = DEFAULT_SIGNAL;
		$state[0xdb + (BYTE * 7)] =512 * 215;
		$signal[0xdb + (BYTE * 7)] = DEFAULT_SIGNAL;
		$state[0xdc + (BYTE * 7)] =512 * 216;
		$signal[0xdc + (BYTE * 7)] = DEFAULT_SIGNAL;
		$state[0xdd + (BYTE * 7)] =512 * 217;
		$signal[0xdd + (BYTE * 7)] = DEFAULT_SIGNAL;
		$state[0xde + (BYTE * 7)] =512 * 218;
		$signal[0xde + (BYTE * 7)] = DEFAULT_SIGNAL;
		$state[0xdf + (BYTE * 7)] =512 * 219;
		$signal[0xdf + (BYTE * 7)] = DEFAULT_SIGNAL;
	}
...
#L
{
	...
	#10 состояние 1-байтные опкоды
	{
		...
		#coprocessor
		$state[0xd8 + (BYTE * 10)] =512 * 228;
		$signal[0xd8 + (BYTE * 10)] = DEFAULT_SIGNAL;
		$state[0xd9 + (BYTE * 10)] =512 * 229;
		$signal[0xd9 + (BYTE * 10)] = DEFAULT_SIGNAL;
		$state[0xda + (BYTE * 10)] =512 * 230;
		$signal[0xda + (BYTE * 10)] = DEFAULT_SIGNAL;
		$state[0xdb + (BYTE * 10)] =512 * 231;
		$signal[0xdb + (BYTE * 10)] = DEFAULT_SIGNAL;
		$state[0xdc + (BYTE * 10)] =512 * 232;
		$signal[0xdc + (BYTE * 10)] = DEFAULT_SIGNAL;
		$state[0xdd + (BYTE * 10)] =512 * 233;
		$signal[0xdd + (BYTE * 10)] = DEFAULT_SIGNAL;
		$state[0xde + (BYTE * 10)] =512 * 234;
		$signal[0xde + (BYTE * 10)] = DEFAULT_SIGNAL;
		$state[0xdf + (BYTE * 10)] =512 * 235;
		$signal[0xdf + (BYTE * 10)] = DEFAULT_SIGNAL;
	}
...
#M
{
	...
	#1 состояние 1-байтные опкоды
	{
		...
		#coprocessor
		$state[0xd8 + (BYTE * 1)] =512 * 236;
		$signal[0xd8 + (BYTE * 1)] = DEFAULT_SIGNAL;
		$state[0xd9 + (BYTE * 1)] =512 * 237;
		$signal[0xd9 + (BYTE * 1)] = DEFAULT_SIGNAL;
		$state[0xda + (BYTE * 1)] =512 * 238;
		$signal[0xda + (BYTE * 1)] = DEFAULT_SIGNAL;
		$state[0xdb + (BYTE * 1)] =512 * 239;
		$signal[0xdb + (BYTE * 1)] = DEFAULT_SIGNAL;
		$state[0xdc + (BYTE * 1)] =512 * 240;
		$signal[0xdc + (BYTE * 1)] = DEFAULT_SIGNAL;
		$state[0xdd + (BYTE * 1)] =512 * 241;
		$signal[0xdd + (BYTE * 1)] = DEFAULT_SIGNAL;
		$state[0xde + (BYTE * 1)] =512 * 242;
		$signal[0xde + (BYTE * 1)] = DEFAULT_SIGNAL;
		$state[0xdf + (BYTE * 1)] =512 * 243;
		$signal[0xdf + (BYTE * 1)] = DEFAULT_SIGNAL;
	}
...
#N
{
	...
	#2 состояние 1-байтные опкоды
	{
		...
		#coprocessor
		$state[0xd8 + (BYTE * 2)] =512 * 244;
		$signal[0xd8 + (BYTE * 2)] = DEFAULT_SIGNAL;
		$state[0xd9 + (BYTE * 2)] =512 * 245;
		$signal[0xd9 + (BYTE * 2)] = DEFAULT_SIGNAL;
		$state[0xda + (BYTE * 2)] =512 * 246;
		$signal[0xda + (BYTE * 2)] = DEFAULT_SIGNAL;
		$state[0xdb + (BYTE * 2)] =512 * 247;
		$signal[0xdb + (BYTE * 2)] = DEFAULT_SIGNAL;
		$state[0xdc + (BYTE * 2)] =512 * 248;
		$signal[0xdc + (BYTE * 2)] = DEFAULT_SIGNAL;
		$state[0xdd + (BYTE * 2)] =512 * 249;
		$signal[0xdd + (BYTE * 2)] = DEFAULT_SIGNAL;
		$state[0xde + (BYTE * 2)] =512 * 250;
		$signal[0xde + (BYTE * 2)] = DEFAULT_SIGNAL;
		$state[0xdf + (BYTE * 2)] =512 * 251;
		$signal[0xdf + (BYTE * 2)] = DEFAULT_SIGNAL;
	}
